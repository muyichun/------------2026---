...
\begin{table}[!htbp]
    \centering
    \bicaption{\enspace 实验光学系统器件列表}{\enspace List of optical components in the experimental setup}
...
\begin{table}[!htbp]
    \centering
    \bicaption{\enspace 训练配置与超参数设置}{\enspace Training configuration and hyperparameters}
...
\begin{table}[!htbp]
    \centering
    \bicaption{\enspace 硬件环境配置}{\enspace Hardware environment configuration}
