...
\begin{figure}[!htbp]
    ...
    \bicaption{\enspace 多模光纤结构与传输示意图\citep{snyder1983optical,sun2024dl_fiber_imaging}}
              {\enspace Structure and transmission diagram of multimode fiber\citep{snyder1983optical,sun2024dl_fiber_imaging}}
...
\begin{figure}[!htbp]
    ...
    \bicaption{\enspace 全连接深度神经网络(DNN)结构示意图\citep{lecun2015deep}}
              {\enspace Fully connected neural network (Deep Neural Network, DNN) architecture\citep{lecun2015deep}}
    \label{fig:dnn}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \bicaption{\enspace 卷积神经网络（CNN）结构示意图\citep{lecun2015deep}}
              {\enspace Schematic diagram of Convolutional Neural Network (CNN) architecture\citep{lecun2015deep}}
    \label{fig:cnn}
\end{figure}
